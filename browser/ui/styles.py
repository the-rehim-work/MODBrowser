...
#appMenu::item:selected, QMenu::item:selected {
    background-color: #3c4043;
}
...
#downloadsActionBtn:hover {
    background-color: #5f6368;
}

#downloadsActionBtn:disabled {
    color: #5f6368;
    background-color: #292a2d;
}
